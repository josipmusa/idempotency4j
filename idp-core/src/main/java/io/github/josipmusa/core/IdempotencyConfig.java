...
public final class IdempotencyConfig {
    ...
    public Duration defaultLockTimeout() { return defaultLockTimeout; }
    ...
    public static final class Builder {
        ...
        public Builder defaultLockTimeout(Duration timeout) { this.defaultLockTimeout = timeout; return this; }
        public Builder keyRequired(boolean required) { this.keyRequired = required; return this; }
        public IdempotencyConfig build() { return new IdempotencyConfig(this); }
    }
}
