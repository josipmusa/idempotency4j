 ...
 *   <li>{@link io.github.josipmusa.idempotency.core.StoredResponse} — captured HTTP response
 *       replayed to duplicate callers.</li>
 *   <li>{@link io.github.josipmusa.idempotency.core.ResponseSanitizer} — SPI for scrubbing
