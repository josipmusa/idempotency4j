 ...
 *
 * <p>This means another request holds the identity as IN_PROGRESS and did not
 ...
 *
 * <p>Carries the identity and timeout for logging and error responses.
 */
public class IdempotencyLockTimeoutException extends IdempotencyException {
    ...
    public IdempotencyLockTimeoutException(IdempotencyIdentity identity, Duration lockTimeout) {
        super("Lock timeout expired for " + identity + " with timeout " + lockTimeout);
