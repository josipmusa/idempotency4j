 ...
 *       captures the response, and calls {@code store.complete()} with the acquired lease.</li>
 ...
 * lease after a successful action. The engine does not call {@code complete} — this boundary is
 * intentional.
 */
